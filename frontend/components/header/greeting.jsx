	...
	render() {
		...
		return (
			<header>
				<div id="leftnav">
					<Link to="/">
						<i className="fab fa-pinterest logo fa-2x" />
					</Link>
				</div>
				<div id="rightnav">
					<Link to="/">
						<h1 className={this.state.currentPage === 'home' ? 'home active' : 'home'}>Home</h1>
					</Link>
					<Link to="/following">
						<h1 className={this.state.currentPage === 'following' ? 'home active' : 'home'}>Following</h1>
					</Link>
					...
					<div className="dropdown">
						<i onClick={this.toggleClass} className="dropbtn fas fa-ellipsis-h fa-lg" />
						{this.state.active ? (
