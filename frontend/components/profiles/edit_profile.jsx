					...
					<div className="formContainer">
						<div className="headingsContainer">
							...
							<div className="buttonsContainer">
								<button id="doneBtn" onClick={this.handleSubmit}>
									Done
								</button>
							</div>
						</div>
						...
						<form id="editForm">
							...
							<label>
								About your profile<br />
								<textarea placeholder="Write a little about yourself here" />
							</label>
							<label id="editLocation">
								Location<br />
