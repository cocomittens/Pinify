...
export const fetchUser = username => dispatch => {
    return APIUtil.fetchUser(username)
        .then(user => dispatch(receiveUser(user)), errors => dispatch(receiveSessionErrors(errors)))
};

export const addFollow = follow => dispatch => {
    return APIUtil.addFollow(follow)
        .then(follow => dispatch(receiveFollow(follow)), errors => dispatch(receiveSessionErrors(errors)))
}
